...
const AllBlogs = () => {
    const data = [{
        content: " React is a powerful JavaScript library for building user interfaces. In this comprehensive guide, we'll explore the fundamentals of React, from setting up a development environment to building complex, interactive applications.",
                        ...
                        {data.map((items) => {
                            return (
                                <div key={items} className="bg-white p-4 rounded-lg shadow">
                                    <Image src={items.image} width={1600} height={800} alt="Post thumbnail" className="w-full h-60 object-cover rounded-lg mb-4" />
