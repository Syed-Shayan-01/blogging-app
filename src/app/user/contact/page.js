...
const ContactUs = () => {
  return (
    <>
    <div class="my-36">
            <div class="grid sm:grid-cols-2 items-center gap-16 p-8 mx-auto max-w-3xl bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-md text-[#333] font-[sans-serif]">
                <div>
                    ...
                    <div class="mt-12">
                        ...
                        <ul class="mt-3">
                            <li class="flex items-center">
                                ...
                                <a target="blank"  class="text-[#007bff] text-sm ml-3">
                                    <small class="block">Mail</small>
                                    <strong>shayansyed712@gmail.com</strong>
                                </a>
                            </li>
                        </ul>
                    </div>
